...
def parse_args():
    ...
    parser.add_argument("--fp_remove", type=bool, required=False, default=False, help="是否开启误报消除，默认False")
...
access_model_path = None
                          
processed_access_control_model_path = None
                                                  
complete_access_model_path = None
                
output_access_control_model_path = None
          
call_chains_path = None
            
after_reducing_false_positives_path = None
        ...
        for j, model in enumerate(access_control_models):
            ...
            for k, missing_permission in enumerate(model["missing_permission"]):
                ...
                if result_equivalent_permission_operation["has_equivalent_permission"] == "no" and\
                    ...
                    break
                if k == len(model["missing_permission"]) - 1:
